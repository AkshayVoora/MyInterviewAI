...
function PreparationPage({ score, setScore }) {
   ...
   const questions = [
      { question: 'What is the time complexity of binary search?', options: ['O(n)', 'O(log n)', 'O(n log n)', 'O(n^2)'], correctAnswer: 'O(log n)' },
      { question: 'Which data structure uses FIFO?', options: ['Stack', 'Queue', 'Tree', 'Graph'], correctAnswer: 'Queue' },
      { question: 'What is the output of 2 + 2 * 3?', options: ['12', '10', '8', '6'], correctAnswer: '8' },
   ];
